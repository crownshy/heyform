...
async function bootstrap() {
	...
	// 	})
	// )
	let allowedAncestors = ["'self'", "https://demo.comhairle.scot", "https://community.comhairle.scot", "https://stage.comhairle.scot", "https://comhairle.scot", "http://localhost:*", "https://la.comhairle.scot", "https://www.rewritela.org/", "https://flow.crown-shy.com"]
	app.use(
		helmet({
