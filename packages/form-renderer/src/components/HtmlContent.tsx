...
// swapped for the Radix <Tooltip>, which portals out of overflow containers and
...
const options: HTMLReactParserOptions = {
  replace: domNode => {
    ...
    return (
      <Tooltip ariaLabel={definition} contentClassName="heyform-tooltip-inline">
        <span className="heyform-tooltip" tabIndex={0}>
